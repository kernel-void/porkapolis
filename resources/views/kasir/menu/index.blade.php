                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center">
                                        <button class="btn btn-warning btn-sm btn-circle editBtn mr-1"
                                            ...
                                            data-url="{{ route('kasir.menu.update', $menuItem->id) }}"
                                            data-id="{{ $menuItem->id }}"
                                        ...
                                        <button class="btn btn-danger btn-sm btn-circle deleteBtn"
                                            ...
                                            data-url="{{ route('kasir.menu.destroy', $menuItem->id) }}">
...
@include('kasir.menu.create')
@include('kasir.menu.edit')
@include('kasir.menu.delete')
@include('kasir.menu.restore')
@endsection
