...
<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('owner.pemasukan.store') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" inputmode="numeric" name="total" id="total" class="form-control" placeholder="Masukkan total" required oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                    </div>
