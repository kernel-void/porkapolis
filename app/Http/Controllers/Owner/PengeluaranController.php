...
class PengeluaranController extends Controller
{
    public function index()
    {
        ...
        return view('owner.pengeluaran.index', compact('pengaturan', 'pengeluaran', 'deletedData'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('owner.pengeluaran.index')->with('success', 'Pengeluaran berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('owner.pengeluaran.index')->with('success', 'Data pengeluaran berhasil diperbarui');
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $html = view('owner.pengeluaran.pdf', compact('pengeluaran'))->render();
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $pengeluaran->keterangan = '[Dihapus oleh: ' . $userName . ']';
        $pengeluaran->save();
